    ...
    return (
        <section className='auth-section'>
            ...
            <div className='auth-container-2'>
                {!isSignup && <img src={icon} alt='stack overflow' style={{ width: "50px", height: "50px" }} className='login-logo' />}
                <form onSubmit={handleSubmit}>
                    ...
                    <label htmlFor='password'>
                        <div style={{ display: "flex", justifyContent: "space-between" }}>
                            <h4>Password</h4>
                           <p style={{textDecoration:'none', color: "#007ac6", fontSize: "13px", paddingTop:"8px",cursor:"pointer"}} onClick={()=>navigate("/password-reset")}>Forget Password</p>
                        </div>
                ...
                <p>
                    {isSignup ? 'alredy have a account?' : "Don't have an account"}
